...
while True:
    ...
    textoVermelho = fonte.render('Vermelho Ganhou!', True, preto)
    textoAmarelo = fonte.render('Amarelo Ganhou!', True, preto)
    textoAzul = fonte.render('Azul Ganhou!', True, preto)
    ...
    if acabou:
        tela.fill(preto)
        novo_fundo = pygame.image.load('Recursos/finalbackground.jpg')
        ...
        texto_vencedor_final = fonte_final.render(f'1º lugar: Carro {firstPlace}', True, preto)
        texto_distancia_1_2 = fonte_final.render(f'Distância para o 2º lugar: {distancia_primeiro_segundo} pixels', True, preto)
        texto_segundo_final = fonte_final.render(f'2º lugar: Carro {secondPlace}', True, preto)
        texto_distancia_2_3 = fonte_final.render(f'Distância para o 3º lugar: {distancia_segundo_terceiro} pixels', True, preto)
        texto_terceiro_final = fonte_final.render(f'3º lugar: Carro {thirdPlace}', True, preto)
